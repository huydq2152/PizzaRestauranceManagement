...
public static class Hook
{
        ...
        var traceConfig = Sdk.CreateTracerProviderBuilder()
            ...
            .AddOtlpExporter(otlpOptions =>
            {
                otlpOptions.Endpoint =
                    new Uri(Environment.GetEnvironmentVariable("OTLP_ENDPOINT") ?? "http://localhost:4317");
            });
    ...
    {
        CurrentActivity =
            Source.StartActivity(scenarioContext.ScenarioInfo.Title, ActivityKind.Client, RootActivity.Context);
