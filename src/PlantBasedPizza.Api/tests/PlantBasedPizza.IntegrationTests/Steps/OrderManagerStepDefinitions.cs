...
public sealed class OrderManagerStepDefinitions
{
    ...
    {
        await _driver.CollectOrder(p0).ConfigureAwait(false);
    }
    ...
    {
        await _driver.AddNewDeliveryOrder(p0);
    }
}